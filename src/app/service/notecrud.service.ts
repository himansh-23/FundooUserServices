...
export class NotecrudService {
  ...
  public addCollaboratorNote(sharedUserId: Number, sharedNoteId: Number): any {
    return this.http.post(this.collabUrl + "?sharedUserId=" + sharedUserId + "&sharedNoteId=" + sharedNoteId,null,httpOptions2);
  }
  ...
  public deleteCollaborator(noteId: Number, email: String): any {
